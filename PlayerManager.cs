...
public class PlayerManager : MonoBehaviour {
    ...
    public void Grab(GameObject theGrabbler, GameObject maHips, Grabbable maGrabbable, GameObject tharHips, Grabbable theirGrabbable)
    {
        // TEST
        if (tharHips != null)
        { 
    ...
    public void Throw(GameObject theGrabbler, GameObject maHips, Grabbable maGrabbable, GameObject tharHips, Grabbable theirGrabbable)
    {
    ...
    public void Drop(GameObject theGrabbler, GameObject maHips, Grabbable maGrabbable, GameObject tharHips, Grabbable theirGrabbable)
    {
    ...
    public void GrabDecide(int Grabbler)
    {
        // Find Yer Stuff
        ...
        {
            Grab(theGrabbler, maHips, maGrabbable, tharHips, theirGrabbable);
        }
        else if (maGrabbable.grabMode == "grabbing")
        {
            Drop(theGrabbler, maHips, maGrabbable, tharHips, theirGrabbable);
        }
        else
        {
    ...
    public List<T> GrabInfo(int Grabbler)
    {
        // Find Yer Stuff
        ...
        // https://stackoverflow.com/questions/13687321/c-sharp-different-class-objects-in-one-list
        ...
        GameObject tharHips = maGrabbable.tharHips;
        Grabbable theirGrabbable = tharHips.GetComponent<Grabbable>();
        return {theGrabbler, maHips, maGrabbable, tharHips, theirGrabbable};
    }
...
//  staminatimes[i] corresponds to players[i] and is a float array of time until a balance point is added
